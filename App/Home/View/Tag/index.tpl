...
<div class="container content">
    <div class="row">
        <div class="col-md-8">
            <ul id="lists">
                {if $total eq "0"}
                    <li style="text-align: center;margin: .3rem auto;padding: 0;background: none">
                        <img src="{$APP}/Public/Img/error.png" style="max-width: 100%;margin: .3rem auto;display: block">
                        <span>该分类还暂时没有文章，请稍后再来。回到<a href="{$APP}/" style="margin: 0 .1rem;color: #0000cc">首页</a>吧！</span>
                    </li>
                {/if}
                {foreach from=$articleList item=aList}
                    <li id="list">
                        ...
                        <a href="{$APP}/article/index/id/{$aList.article_id}" class="btn btn-default my-btn">阅读全文</a>
                        <hr />
                        <footer>
